...
class _$LoginTearOff {
  ...
  _Login call({String? email, String? password, bool isLoading = false}) {
    return _Login(
      email: email,
      password: password,
      isLoading: isLoading,
...
class _$_Login implements _Login {
  const _$_Login({this.email, this.password, this.isLoading = false});
  ...
  @override
  String toString() {
    return 'Login(email: $email, password: $password, isLoading: $isLoading)';
  }
...
abstract class _Login implements Login {
  const factory _Login({String? email, String? password, bool isLoading}) =
      _$_Login;
